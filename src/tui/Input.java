...
public class Input {
	...
	/**
	 * Метод, проверяющий, является ли полученный int положительным (> 0).
	 * Пример использования: int x = tui.Input.positiveIntIn(tui.Input.intIn())
	 *
	...
	/**
	 * Метод, проверяющий, является ли полученный int неотрицательным (>= 0).
	 * Пример использования: int x = tui.Input.positiveIntIn(tui.Input.intIn())
	 *
	 * @param number исходное целое число
	 ...
	 * Пример использования: float x = tui.Input.positiveFloatIn(tui.Input.floatIn())
	 *
